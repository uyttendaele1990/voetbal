    ...
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) als ik deze cdn gebruik blijft mijn error ivm boostrap needs jquerry en mijn datatables gaan kapot dus heb ik dit uitgecomment-->
